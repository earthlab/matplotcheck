...
class RasterTester(PlotTester):
	...
	def assert_image(self, im_expected, im_classified = False, m='Incorrect Image Displayed'):
		...
		if im_classified:
			...
			assert np.array_equal(im_data, im_expected) or np.array_equal(im_data_rev, im_expected), m
		else:
